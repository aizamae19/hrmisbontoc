                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    <a href="" title="Edit" href="{{ url('/notice/index/edit').'/'.$notice->id}}" class="btn btn-sm btn-primary waves-effect waves-light leavetype" data-id="9"><i class="fa fa-pencil-square-o"></i></a>
